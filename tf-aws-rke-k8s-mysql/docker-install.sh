#!/bin/sh
set -e
#This is not the original script from https://get.docker.com/
#because of that script doesn`t support Amazon linux
#To address this issue added the $lsb_dist == amzn case
